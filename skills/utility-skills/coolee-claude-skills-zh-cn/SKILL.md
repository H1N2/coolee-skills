---
name: coolee-claude-skills-zh-cn
description: Provides Chinese translations of Anthropic Skills collection including algorithmic-art, docx, pdf, pptx, xlsx, and other common skills. Use when users request Chinese skill documentation or need reference for implementing Chinese versions of skills.
---
